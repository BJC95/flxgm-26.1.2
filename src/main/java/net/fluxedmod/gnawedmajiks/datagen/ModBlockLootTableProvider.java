...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropSelf(ModBlocks.STRIPPED_SORROWSPRUCE_WOOD.get());
        dropSelf(ModBlocks.STRIPPED_SORROWSPRUCE_LOG.get());
        dropSelf(ModBlocks.SORROWSPRUCE_STAIRS.get());
        dropSelf(ModBlocks.SORROWSPRUCE_BUTTON.get());
