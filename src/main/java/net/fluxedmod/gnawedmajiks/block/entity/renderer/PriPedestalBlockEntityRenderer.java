...
public class PriPedestalBlockEntityRenderer
        implements BlockEntityRenderer<PriPedestalBlockEntity, PedestalBlockEntityRenderState> {

    private final ItemModelResolver itemModelResolver;

    public PriPedestalBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
        itemModelResolver = context.itemModelResolver();
    }

    @Override
    public void extractRenderState(PriPedestalBlockEntity blockEntity, PedestalBlockEntityRenderState state,
