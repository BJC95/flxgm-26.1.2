...
public class TriPedestalBlockEntityRenderer
        implements BlockEntityRenderer<TriPedestalBlockEntity, PedestalBlockEntityRenderState> {

    private final ItemModelResolver itemModelResolver;

    public TriPedestalBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
        itemModelResolver = context.itemModelResolver();
    }

    @Override
    public void extractRenderState(TriPedestalBlockEntity blockEntity, PedestalBlockEntityRenderState state,
