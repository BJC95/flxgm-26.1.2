...
public class SecPedestalBlock extends AbstractPedestalBlock{
    public static final MapCodec<AbstractPedestalBlock> CODEC = simpleCodec(SecPedestalBlock::new);

    public SecPedestalBlock(Properties properties) {
        super(properties);
    }

    @Override
    public @Nullable BlockEntity newBlockEntity(BlockPos worldPosition, BlockState blockState) {
        return new SecPedestalBlockEntity(worldPosition, blockState);
    }

    @Override
    protected InteractionResult useItemOn(ItemStack itemStack, BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hitResult) {
        if(level.getBlockEntity(pos) instanceof SecPedestalBlockEntity pedestalBlockEntity) {
    ...
    protected void particleBurst(SecPedestalBlockEntity pedestalBlockEntity, ParticleOptions particleOptions) {
        double randX;
        double randY;
        double randZ;
