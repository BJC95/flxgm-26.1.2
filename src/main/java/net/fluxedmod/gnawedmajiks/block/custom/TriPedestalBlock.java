...
public class TriPedestalBlock extends AbstractPedestalBlock{
    public static final MapCodec<AbstractPedestalBlock> CODEC = simpleCodec(TriPedestalBlock::new);

    public TriPedestalBlock(Properties properties) {
        super(properties);
    }

    @Override
    public @Nullable BlockEntity newBlockEntity(BlockPos worldPosition, BlockState blockState) {
        return new TriPedestalBlockEntity(worldPosition, blockState);
    }

    @Override
    protected InteractionResult useItemOn(ItemStack itemStack, BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hitResult) {
        if(level.getBlockEntity(pos) instanceof TriPedestalBlockEntity pedestalBlockEntity) {
    ...
    protected void particleBurst(TriPedestalBlockEntity pedestalBlockEntity, ParticleOptions particleOptions) {
        double randX;
        double randY;
        double randZ;
